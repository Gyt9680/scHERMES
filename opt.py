...
parser = argparse.ArgumentParser(description='scHERMES', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
...
parser.add_argument('--lambda3', type=float, default=10) # KL loss weight
parser.add_argument('--lambda_cross', type=float, default=10)
parser.add_argument('--lambda_cross_pretrain', type=float, default=0.1)
...
# clustering performance placeholder
